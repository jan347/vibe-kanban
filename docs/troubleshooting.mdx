...
description: "Common issues and solutions when using GenCap Control Room"
---
...
If you encounter irrecoverable errors and need to completely wipe your GenCap Control Room database, you can delete the application data directory for your operating system. 
...
<Tab title="macOS">
```bash
~/Library/Application Support/co.gencap.control-room/
```
</Tab>
...
<Tab title="Windows">
```
%APPDATA%\bloop\gencap\
```

Typically: `C:\Users\<username>\AppData\Roaming\bloop\gencap\`
</Tab>
</Tabs>

After deleting the application data directory, restart GenCap Control Room to reset with an empty database and default settings.
