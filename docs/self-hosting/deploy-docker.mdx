...
description: "Deploy GenCap Control Room Cloud on any server using Docker Compose"
---

This guide covers deploying GenCap Control Room Cloud on any Linux server using Docker Compose. This approach works with any cloud provider (AWS, DigitalOcean, Hetzner, etc.) or on-premises server.
...
Clone the GenCap Control Room repository:

```bash
git clone https://github.com/BloopAI/gencap.git
cd gencap
```
...
2. You should see the GenCap Control Room Cloud login page
