...
description: "Run GenCap Control Room Cloud locally"
---

This guide walks you through setting up a local GenCap Control Room Cloud instance for development and testing.
...
3. Fill in the details:
   - **Application name**: GenCap Control Room Local
...
Open [http://localhost:3000](http://localhost:3000) in your browser. You should see the GenCap Control Room Cloud login page.
