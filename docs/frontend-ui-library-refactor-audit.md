...
- `extract-now`: move in first `@gencap/ui` package wave.
...
- Treat `components/ui/wysiwyg` as a separate future package (`@gencap/editor-ui`) after `@gencap/ui` lands.
...
| --- | --- | --- | --- |
| `ui-new/primitives/Accordion.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
...
| `ui-new/primitives/AutoResizeTextarea.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
| `ui-new/primitives/ChatBoxBase.tsx` | `keep-app` | `frontend-app` | Domain-specific primitive for kanban/chat/workspace flows. |
| `ui-new/primitives/CollapsibleSectionHeader.tsx` | `extract-later` | `@gencap/ui` | Primitive UI component; good first package candidate. Move after decoupling @/stores. |
| `ui-new/primitives/ColorPicker.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
| `ui-new/primitives/Command.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
| `ui-new/primitives/CommandBar.tsx` | `extract-later` | `@gencap/ui` | Potentially reusable but needs API cleanup. Requires decoupling from @/components/*. |
...
| `ui-new/primitives/Dialog.tsx` | `extract-later` | `@gencap/ui` | Primitive UI component; good first package candidate. Move after decoupling @/contexts. |
| `ui-new/primitives/Dropdown.tsx` | `extract-later` | `@gencap/ui` | Primitive UI component; good first package candidate. Move after decoupling @/contexts. |
| `ui-new/primitives/EmojiPicker.tsx` | `extract-later` | `@gencap/ui` | Potentially reusable but needs API cleanup. Requires decoupling from @/contexts. |
| `ui-new/primitives/ErrorAlert.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
| `ui-new/primitives/GoogleLogo.tsx` | `keep-app` | `frontend-app` | Domain-specific primitive for kanban/chat/workspace flows. |
| `ui-new/primitives/IconButton.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
| `ui-new/primitives/IconButtonGroup.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
| `ui-new/primitives/InputField.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
...
| `ui-new/primitives/MultiSelectCommandBar.tsx` | `extract-later` | `@gencap/ui` | Potentially reusable but needs API cleanup. |
| `ui-new/primitives/MultiSelectDropdown.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
| `ui-new/primitives/OAuthButtons.tsx` | `keep-app` | `frontend-app` | Domain-specific primitive for kanban/chat/workspace flows. |
| `ui-new/primitives/Popover.tsx` | `extract-later` | `@gencap/ui` | Primitive UI component; good first package candidate. Move after decoupling @/contexts. |
| `ui-new/primitives/PrBadge.tsx` | `keep-app` | `frontend-app` | Domain-specific primitive for kanban/chat/workspace flows. |
| `ui-new/primitives/PrimaryButton.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
...
| `ui-new/primitives/RunningDots.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
| `ui-new/primitives/SearchableDropdown.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
...
| `ui-new/primitives/SplitButton.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
| `ui-new/primitives/StatusDot.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
...
| `ui-new/primitives/Toggle.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
| `ui-new/primitives/Toolbar.tsx` | `extract-now` | `@gencap/ui` | Primitive UI component; good first package candidate. |
| `ui-new/primitives/Tooltip.tsx` | `extract-later` | `@gencap/ui` | Primitive UI component; good first package candidate. Move after decoupling @/contexts. |
...
| Component | Status | Target package | Notes |
| --- | --- | --- | --- |
| `ui/wysiwyg/context/task-attempt-context.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/context/typeahead-open-context.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/lib/create-decorator-node.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/nodes/component-info-node.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/nodes/image-node.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. Requires decoupling from @/hooks, @/components/*. |
| `ui/wysiwyg/nodes/pr-comment-node.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/plugins/clickable-code-plugin.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/plugins/code-block-shortcut-plugin.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/plugins/code-highlight-plugin.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/plugins/component-info-keyboard-plugin.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/plugins/file-tag-typeahead-plugin.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. Requires decoupling from @/components/*, @/contexts, @/lib/*api, @/stores. |
| `ui/wysiwyg/plugins/image-keyboard-plugin.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/plugins/keyboard-commands-plugin.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/plugins/markdown-sync-plugin.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/plugins/paste-markdown-plugin.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/plugins/read-only-link-plugin.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/plugins/slash-command-typeahead-plugin.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. Requires decoupling from @/contexts, @/hooks. |
| `ui/wysiwyg/plugins/static-toolbar-plugin.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |
| `ui/wysiwyg/plugins/toolbar-plugin.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. Requires decoupling from @/contexts. |
| `ui/wysiwyg/plugins/typeahead-menu-components.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. |

### ui

| Component | Status | Target package | Notes |
| --- | --- | --- | --- |
| `ui/alert.tsx` | `extract-now` | `@gencap/ui` | Core shadcn-style primitive with low business coupling. |
| `ui/auto-expanding-textarea.tsx` | `extract-now` | `@gencap/ui` | Core shadcn-style primitive with low business coupling. |
| `ui/badge.tsx` | `extract-now` | `@gencap/ui` | Core shadcn-style primitive with low business coupling. |
| `ui/button.tsx` | `extract-now` | `@gencap/ui` | Core shadcn-style primitive with low business coupling. |
| `ui/card.tsx` | `extract-now` | `@gencap/ui` | Core shadcn-style primitive with low business coupling. |
| `ui/checkbox.tsx` | `extract-now` | `@gencap/ui` | Core shadcn-style primitive with low business coupling. |
| `ui/dialog.tsx` | `extract-later` | `@gencap/ui` | Reusable but currently tied to app context/portal behavior. Requires decoupling from @/keyboard. |
| `ui/dropdown-menu.tsx` | `extract-later` | `@gencap/ui` | Reusable but currently tied to app context/portal behavior. Requires decoupling from @/contexts. |
| `ui/input.tsx` | `extract-now` | `@gencap/ui` | Core shadcn-style primitive with low business coupling. |
| `ui/label.tsx` | `extract-now` | `@gencap/ui` | Core shadcn-style primitive with low business coupling. |
| `ui/loader.tsx` | `extract-now` | `@gencap/ui` | Core shadcn-style primitive with low business coupling. |
| `ui/pr-comment-card.tsx` | `keep-app` | `frontend-app` | PR domain card component. |
| `ui/select.tsx` | `extract-later` | `@gencap/ui` | Reusable but currently tied to app context/portal behavior. Requires decoupling from @/contexts. |
| `ui/switch.tsx` | `extract-now` | `@gencap/ui` | Core shadcn-style primitive with low business coupling. |
| `ui/textarea.tsx` | `extract-now` | `@gencap/ui` | Core shadcn-style primitive with low business coupling. |
| `ui/tooltip.tsx` | `extract-later` | `@gencap/ui` | Reusable but currently tied to app context/portal behavior. Requires decoupling from @/contexts. |
| `ui/wysiwyg.tsx` | `extract-later` | `@gencap/editor-ui` | Editor subsystem; split as a dedicated package later. Requires decoupling from @/vscode. |
...
| Component | Status | Target package | Notes |
| --- | --- | --- | --- |
| `ui/table/data-table.tsx` | `extract-later` | `@gencap/ui` | Reusable table building blocks; defer until core package is stable. |
| `ui/table/table.tsx` | `extract-later` | `@gencap/ui` | Reusable table building blocks; defer until core package is stable. |
