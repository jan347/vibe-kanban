---
title: "Remote Access"
description: "Access your local GenCap Control Room instance from another device"
---

Remote Access allows you to access a host instance of GenCap Control Room from another device, like your mobile phone.

# 1. Launch GenCap Control Room on the host device

Make sure you've started GenCap Control Room and logged in.
...
# 3. Log into GenCap Control Room cloud
...
<Frame>
  <img style={{maxHeight: "500px"}} src="/images/remote-access-cloud-mobile.png" alt="GenCap Control Room cloud remote access page on mobile showing a paired host and workspaces" />
</Frame>
