---
title: "GenCap Control Room Cloud"
description: "Collaborate with your team in real-time with Cloud features"
sidebarTitle: "Overview"
---

## What is GenCap Control Room Cloud?

**GenCap Control Room Cloud** adds team collaboration to GenCap Control Room. Your projects, issues, and progress sync to the cloud so your entire team stays in sync.
...
<Card title="Same Interface" icon="desktop">
  Cloud uses the same GenCap Control Room interface you already know. No new tools to learn.
</Card>
</CardGroup>
...
<Info>
You can use both Local and Cloud projects in the same GenCap Control Room installation. They appear in separate sections of the sidebar.
</Info>

## How It Works

1. **Run GenCap Control Room** as usual with `npx gencap`
...
Think of it as your company or team in GenCap Control Room.
...
- Review code directly in GenCap Control Room
- Track PR status

## Getting Started

<Steps>
<Step title="Run GenCap Control Room">
  ```bash
  npx gencap
  ```
</Step>
