...
Organisations are the top-level container in GenCap Control Room Cloud. They group your team members and projects together.
...
- [Getting Started](/cloud/getting-started) - Initial setup of GenCap Control Room Cloud
