...
description: "Solutions for common issues with GenCap Control Room Cloud"
---

This page covers common issues you might encounter with GenCap Control Room Cloud and how to resolve them.
...
4. Return to GenCap Control Room and sign in again
</Accordion>
...
3. Try a different browser
4. Restart GenCap Control Room (`npx gencap`)
</Accordion>
...
1. **Check existing issues:** [github.com/BloopAI/gencap/issues](https://github.com/BloopAI/gencap/issues)
...
<Card title="Report an Issue" icon="github" href="https://github.com/BloopAI/gencap/issues/new">
