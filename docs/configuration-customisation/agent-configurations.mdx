...
<Info>
Agent profiles are used throughout GenCap Control Room wherever agents run: onboarding, default settings, attempt creation, and follow-ups.
</Info>
...
<Note>
The configuration page displays the exact file path where your settings are stored. GenCap Control Room saves only your overrides whilst preserving built-in defaults.
</Note>
...
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within GenCap Control Room for your coding agents
</Card>

<Card title="GenCap Control Room MCP Server" icon="plug" href="/integrations/gencap-mcp-server">
  Connect external MCP clients to GenCap Control Room's MCP server
</Card>
</CardGroup>
