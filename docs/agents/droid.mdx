...
<Step title="Authenticate with Factory AI">
  To use Droid in GenCap Control Room, you must first authenticate:
...
Droid supports several configuration options in GenCap Control Room:
...
These options can be configured when creating agent configurations in GenCap Control Room.
