...
## Authentication
Authenticate and configure CCR outside of GenCap Control Room. Follow the instructions on the CCR GitHub repo:
...
## Configure GenCap Control Room

GenCap Control Room does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in GenCap Control Room

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in GenCap Control Room" />
</Frame>

## Using CCR in GenCap Control Room
