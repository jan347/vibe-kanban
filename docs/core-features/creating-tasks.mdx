...
<Tip>
For detailed setup instructions and examples, see the [GenCap Control Room MCP Server](/integrations/gencap-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your GenCap Control Room project based on this description.
