...
When you add a repository to a workspace, GenCap Control Room creates a **git worktree** - a separate working directory linked to your repository.
...
**Where worktrees are stored:** In the `.gencap-workspaces` directory (configurable in Settings).
</Accordion>
