...
//     --download-base "https://github.com/BloopAI/gencap/releases/download/v0.2.0" \
//     --output latest.json
//
// The artifacts-dir should contain Tauri bundle outputs with .sig files:
//   tauri-artifacts/
//     darwin-aarch64/  -> gencap.app.tar.gz, gencap.app.tar.gz.sig
//     darwin-x86_64/   -> gencap.app.tar.gz, gencap.app.tar.gz.sig
//     linux-x86_64/    -> gencap.AppImage.tar.gz, gencap.AppImage.tar.gz.sig
//     windows-x86_64/  -> gencap-setup.exe, gencap-setup.exe.sig (NSIS)
//
