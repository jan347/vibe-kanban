...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::mail::MailThread::decl(),
        db::models::mail::MailThreadKind::decl(),
        db::models::mail::MailMessage::decl(),
        db::models::mail::MailSenderKind::decl(),
        db::models::mail::MailResponseKind::decl(),
        db::models::mail::MailRecipient::decl(),
        db::models::mail::MailRecipientKind::decl(),
        ...
        db::models::model_preset::CreateModelPreset::decl(),
        db::models::model_preset::UpdateModelPreset::decl(),
        db::models::repo_bundle::RepoBundle::decl(),
        db::models::repo_bundle::CreateRepoBundle::decl(),
        db::models::repo_bundle::UpdateRepoBundle::decl(),
        db::models::work_item::WorkItem::decl(),
        db::models::work_item::WorkItemStatus::decl(),
        db::models::work_item::WorkItemRun::decl(),
        db::models::work_item::CreateWorkItem::decl(),
        db::models::work_item::UpdateWorkItem::decl(),
        db::models::work_item::LinkWorkspaceToWorkItem::decl(),
        db::models::work_item::WorkItemWithLinks::decl(),
        db::models::prompt_template::PromptTemplate::decl(),
        db::models::prompt_template::PromptTemplateRole::decl(),
        ...
        db::models::artifact::ArtifactKind::decl(),
        db::models::artifact::CreateArtifact::decl(),
        db::models::artifact::AcceptArtifactRequest::decl(),
        db::models::artifact::SharedContextItem::decl(),
        db::models::dispatch::DispatchLogEntry::decl(),
        db::models::dispatch::DispatchStatus::decl(),
        db::models::dispatch::CreateDispatch::decl(),
        db::models::safety::SafetyConfig::decl(),
        db::models::safety::UpdateSafetyConfig::decl(),
        db::models::safety::SafetyCheckResult::decl(),
        ...
        server::routes::friction::FrictionSnapshot::decl(),
        server::routes::friction::FrictionHeader::decl(),
        server::routes::friction::VentureCard::decl(),
        server::routes::friction::LatestEntry::decl(),
        ...
        db::models::automation::FireAutomationResult::decl(),
