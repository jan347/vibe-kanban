...
export type AutoApprovalLogEntry = { id: string, workspace_id: string, action_kind: string, action_summary: string, decision: string, reasoning: string | null, decided_by: string, decided_at: string, resolved_decision: string | null, resolved_at: string | null, approval_id: string | null, };
...
export type FireAutomationResult = { "status": "approved", rule_id: string, dispatch_id: string, fired_at: string, } | { "status": "blocked", rule_id: string, decision: AutoApprovalDecision, };
 ...
 */
capabilities: { [key in string]?: Array<BaseAgentCapability> }, executors: { [key in BaseCodingAgent]?: ExecutorProfile }, };
