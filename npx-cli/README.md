...
npx gencap --help
npx gencap --version
npx gencap review --help
npx gencap mcp --help
```

## What is GenCap Control Room?

GenCap Control Room is a modern project management tool designed specifically for developers. It helps you organize your coding projects with kanban-style task management while providing powerful integrations with git repositories and AI coding agents.
...
GenCap Control Room provides a complete project management experience with these key capabilities:
...
GenCap Control Room supports customization through its configuration system:
